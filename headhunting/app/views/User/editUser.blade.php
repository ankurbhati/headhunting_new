...
@section('content')
<div class="content row detail-view ">
...
'form-horizontal','id' => 'login-form',  'method' => 'POST')) }}
    ...
    <div class="box col-sm-7">
        ...
        <div class="box-view">
            ...
            <div class="form-group">
                {{ Form::label('signature', 'Signature: ', array('class' => 'col-sm-4')); }}
                <div class="col-sm-12">{{ Form::textarea('signature', $user->signature, array('class' =>
