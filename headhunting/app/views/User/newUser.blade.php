...
@section('content')
<div class="content detail-view row">
    ...
    <div class="box col-sm-6">
        ...
        <div class="box-view">
            ...
            <div class="form-group">
                ...
                control-label')); }}
                <div class="col-sm-4">{{ Form::text('phone_no', "", array('class' => 'form-control', 'placeholder' => 'ex. (704) 888-9999', "data-inputmask"=>'"mask": "(999) 999-9999"', "data-mask")); }} 
